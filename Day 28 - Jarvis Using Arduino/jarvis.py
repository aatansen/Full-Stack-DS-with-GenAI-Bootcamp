...
def play_music():
    music_dir = "music"   # <-- change this to your music folder
    try:
...
while True:
    ...
    # Small talk
        ...
        speak("Turning on everything sir.")
        ser.write(b'0')
        logging.info("User requested to turn on everything.")

    elif "turn off everything" in query:
        speak("Turning off everything sir.")
        ser.write(b'9')
        logging.info("User requested to turn off everything")

    elif "turn on bedroom light" in query:
        speak("Turning on bedroom light sir.")
        ser.write(b'2')
        logging.info("User requested to turn on bedroom light.")

    elif "turn off bedroom light" in query:
        speak("Turning off bedroom light sir.")
        ser.write(b'1')
        logging.info("User requested to turn off bedroom light.")

    elif "turn on table lamp" in query:
        speak("Turning on table lamp sir.")
        ser.write(b'4')
        logging.info("User requested to turn on table lamp.")

    elif "turn off table lamp" in query:
        speak("Turning off table lamp sir.")
        ser.write(b'3')
        logging.info("User requested to turn off table lamp.")

    elif "turn on fan" in query:
        speak("Turning on the fan sir.")
        ser.write(b'6')
        logging.info("User requested to turn on the fan.")

    elif "turn off fan" in query:
        speak("Turning off the fan sir.")
        ser.write(b'5')
        logging.info("User requested to turn off the fan.")

    elif "turn on tv" in query:
        speak("Turning on the TV sir.")
        ser.write(b'8')
        logging.info("User requested to turn on the TV.")

    elif "turn off tv" in query:
        speak("Turning off the TV sir.")
        ser.write(b'7')
        logging.info("User requested to turn off the TV.")
